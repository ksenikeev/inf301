...
public class Main {
    public static void main(String[] args) {
        ...
        Order order1 = Order.builder().cook(cook1).client(client1).pizza(Pizza.Маргарита).date("16.12.2023").build();

        Order order2 = Order.builder().cook(cook1).client(client2).pizza(Pizza.Пипперони).build();
    }
}
